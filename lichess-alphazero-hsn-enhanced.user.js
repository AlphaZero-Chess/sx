    ...
    const LichessManager = {
        ...
        handleGameState(message) {
            ...
            if (STATE.processingMove) {
                ...
                if (stuckTime > 4000) {
                    Logger.error(`⚠️ RAPID RECOVERY - stuck for ${(stuckTime/1000).toFixed(1)}s - auto-resetting`);
            ...
            STATE.moveTimeout = setTimeout(() => {
                if (STATE.processingMove) {
                    Logger.error('⚠️ Move generation timeout - rapid reset');
                    STATE.processingMove = false;
                    STATE.consecutiveFailures++;
                    STATE.stats.errors++;
                    STATE.stats.recoveries++;
        ...
        deepReset() {
            ...
            Logger.success('✅✅ DEEP RESET complete - fully recovered and ready');
        }
    };
